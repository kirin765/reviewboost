# 웨일 스토어 제출 패키지 — ReviewBoost 리뷰 수집기 (v1.5.1)

업로드 파일: **`extension/reviewboost-extension-whale-1.5.1.zip`** (manifest가 ZIP 루트, v1.5.1)

> ⚠️ 제출은 네이버 아이디 로그인 + (최초 1회) 개발자 등록이 필요해 **직접** 하셔야 합니다. 아래 문구를 그대로 붙여넣으면 됩니다.

> 🆕 v1.5.1 (2026-09-16) — 기존 확장앱의 업데이트 제출로 진행합니다 (확장앱 관리 → 해당 확장앱 → 업데이트 요청).
...
**파일 선택**: `reviewboost-extension-whale-1.5.1.zip`
