  ...
  return (
    <main className="pageMain pb-8 pt-8 md:pt-12">
      ...
      <ShellContainer className="max-w-[980px] space-y-6">
        ...
        <section className="rounded-[30px] border border-[color:rgba(31,37,89,0.12)] bg-[var(--rb-surface)] px-6 py-7 md:px-8 md:py-9">
        ...
        <section className="rounded-[26px] border border-[color:rgba(31,37,89,0.12)] bg-[var(--rb-surface)] px-6 py-6 md:px-8">
