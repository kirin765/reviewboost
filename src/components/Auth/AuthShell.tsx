      ...
      <ShellContainer>
        <div className="grid gap-8 lg:grid-cols-[minmax(0,0.92fr)_minmax(420px,0.78fr)] lg:items-start">
          <div className="px-2 py-2 md:px-4">
            ...
            <div className="mt-10 grid gap-4 border-t border-[color:#e6e8f2] pt-6">
              {bullets.map((bullet) => (
                <div key={bullet} className="grid gap-3 border-b border-[color:#e6e8f2] pb-4 text-sm leading-7 text-[var(--rb-muted-strong)] last:border-b-0">
