    ...
    <div className="grid gap-4 xl:grid-cols-4" role="list" aria-label="분석 단계">
      {steps.map((item) => {
        ...
        return (
          <div
            key={item.n}
            className="rounded-[18px] border border-[color:#e6e8f2] bg-white px-4 py-4"
            role="listitem"
          >
              ...
              <span
                className={cn(
                  ...
                  isActive
                    ...
                    : "border-[color:#e6e8f2] bg-[#f4f5fb]"
                )}
                aria-hidden="true"
              >
                <span className={cn("h-2 w-2 rounded-full", isActive ? "bg-[#ffffff]" : "bg-[#e6e8f2]")} />
              </span>
              <div>
