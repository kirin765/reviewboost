  ...
  return (
    <section className="space-y-8">
      <div className="space-y-4">
        <p className="text-[11px] uppercase tracking-[0.22em] text-[var(--rb-muted)]">Current step</p>
            ...
            {step === 1 ? (
              <div className="grid gap-8 xl:grid-cols-[minmax(0,0.92fr)_300px]">
                ...
                <div className="border-t border-[color:rgba(222,230,242,0.08)] pt-6 xl:border-l xl:border-t-0 xl:pl-8 xl:pt-0">
                  <p className="text-[11px] uppercase tracking-[0.2em] text-[var(--rb-muted)]">Upload guide</p>
