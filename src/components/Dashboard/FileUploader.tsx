    ...
    <div>
      ...
      <label
        ...
        className={`mt-5 flex min-h-[220px] cursor-pointer flex-col items-center justify-center rounded-[18px] border border-dashed px-6 text-center transition ${
          dragActive ? "border-[color:rgba(91,92,234,0.36)] bg-[rgba(91,92,234,0.08)]" : "border-[color:var(--rb-border)] bg-[rgba(31,37,89,0.02)]"
        }`}
        onDrop={onDropFile}
      ...
      <div className="mt-5 rounded-[14px] border border-[color:rgba(31,37,89,0.06)] bg-[rgba(31,37,89,0.02)] px-4 py-4 text-sm text-[var(--rb-muted-strong)]" role="status" aria-live="polite">
        {file ? (
          <span>
