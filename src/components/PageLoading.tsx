  ...
  return (
    <main className="pageMain py-12" aria-busy="true" aria-live="polite">
      <ShellContainer className="max-w-[920px]">
        ...
        <section className="rounded-[24px] border border-[color:var(--rb-border)] bg-[var(--rb-surface)] p-6 shadow-[0_24px_50px_rgba(34,46,121,0.09)]">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            <div className="rounded-[18px] border border-[color:rgba(31,37,89,0.06)] bg-[rgba(31,37,89,0.03)] p-4">
              <div className="h-3 w-20 animate-pulse rounded-full bg-[rgba(31,37,89,0.10)]" />
              <div className="mt-4 h-9 w-28 animate-pulse rounded-full bg-[rgba(31,37,89,0.08)]" />
              <div className="mt-3 h-3 w-24 animate-pulse rounded-full bg-[rgba(31,37,89,0.08)]" />
            </div>
            <div className="rounded-[18px] border border-[color:rgba(31,37,89,0.06)] bg-[rgba(31,37,89,0.03)] p-4 md:col-span-2">
              <div className="h-3 w-28 animate-pulse rounded-full bg-[rgba(31,37,89,0.10)]" />
              <div className="mt-4 h-28 animate-pulse rounded-[16px] bg-[rgba(31,37,89,0.06)]" />
            </div>
          </div>

          <div className="mt-4 rounded-[18px] border border-[color:rgba(31,37,89,0.06)] bg-[rgba(31,37,89,0.03)] p-4">
            <div className="h-3 w-24 animate-pulse rounded-full bg-[rgba(31,37,89,0.10)]" />
            <div className="mt-4 space-y-3">
              <div className="h-12 animate-pulse rounded-[14px] bg-[rgba(31,37,89,0.06)]" />
              <div className="h-12 animate-pulse rounded-[14px] bg-[rgba(31,37,89,0.06)]" />
              <div className="h-12 animate-pulse rounded-[14px] bg-[rgba(31,37,89,0.06)]" />
            </div>
          </div>
