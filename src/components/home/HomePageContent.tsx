...
function EditorialIntro({
  ...
  return (
    <div className="grid gap-6 border-b border-[color:rgba(31,37,89,0.1)] pb-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(260px,420px)] lg:items-start">
      <div>
...
function SummaryRibbon({ metrics }: { metrics: Array<{ label: string; value: string }> }) {
  return (
    <div className="grid gap-4 border-b border-[color:rgba(31,37,89,0.08)] pb-5 sm:grid-cols-2 xl:grid-cols-4">
      {metrics.map((metric) => (
    ...
    <div className="space-y-4">
      {categories.map((category, index) => (
        <div key={category.label}>
          ...
          <div className="h-[7px] overflow-hidden rounded-full bg-[rgba(31,37,89,0.08)]">
            <motion.div
...
function LineChart({
  ...
  return (
    <svg viewBox="0 0 420 240" className="h-full w-full" aria-hidden="true">
      ...
      <path d="M0 210H420" stroke="rgba(31,37,89,0.08)" strokeWidth="1" />
...
function HeroPreview({
  ...
  return (
    <div className="mt-12 rounded-[30px] border border-[color:rgba(31,37,89,0.12)] bg-[var(--rb-surface)] p-4 shadow-[0_40px_80px_rgba(34,46,121,0.10)] md:p-6 lg:p-8">
      <div className="grid gap-8 lg:grid-cols-[300px_minmax(0,1fr)]">
        <div className="border-b border-[color:rgba(31,37,89,0.08)] pb-6 lg:border-b-0 lg:border-r lg:pb-0 lg:pr-8">
          ...
          <div className="mt-8 space-y-5">
            <div className="rounded-[20px] border border-[color:rgba(31,37,89,0.08)] bg-[rgba(31,37,89,0.03)] p-4">
              ...
              <div className="mt-4 space-y-4">
                ...
                <div className="border-t border-[color:rgba(31,37,89,0.08)] pt-4">
        ...
        <div className="space-y-7">
          ...
          <div className="grid gap-6 xl:grid-cols-[minmax(0,0.92fr)_minmax(220px,0.62fr)]">
            ...
            <div className="rounded-[22px] border border-[color:rgba(31,37,89,0.08)] bg-[rgba(31,37,89,0.03)] p-5">
...
function ProductWorkspace({
  ...
  return (
    <div className="rounded-[30px] border border-[color:rgba(31,37,89,0.12)] bg-[var(--rb-surface)] p-5 md:p-7">
      <SummaryRibbon metrics={metrics} />

      <div className="mt-7 border-b border-[color:rgba(31,37,89,0.08)] pb-7">
            ...
            <div
              ...
              className={`rounded-full border px-4 py-2 text-sm ${
                index === 1
                  ...
                  : "border-[color:rgba(31,37,89,0.08)] bg-[rgba(31,37,89,0.02)] text-[var(--rb-muted-strong)]"
              }`}
            >
      ...
      <div className="mt-7 grid gap-8 xl:grid-cols-[minmax(0,1.12fr)_320px]">
        <div className="space-y-7">
          <div>
            <p className="text-[11px] uppercase tracking-[0.2em] text-[var(--rb-muted)]">Urgent reviews</p>
            <div className="mt-4 space-y-4">
              <div className="border-b border-[color:rgba(31,37,89,0.08)] pb-4">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            {items.map((item) => (
              <div key={item.title} className="border-t border-[color:rgba(31,37,89,0.08)] pt-4">
        ...
        <div className="border-t border-[color:rgba(31,37,89,0.08)] pt-7 xl:border-l xl:border-t-0 xl:pl-8 xl:pt-0">
          <p className="text-[11px] uppercase tracking-[0.2em] text-[var(--rb-muted)]">Action strip</p>
          <div className="mt-4 space-y-4">
            <div className="rounded-[18px] border border-[color:rgba(31,37,89,0.08)] bg-[rgba(31,37,89,0.03)] p-4">
...
function ResultGraph({
  ...
  return (
    <div className="rounded-[30px] border border-[color:rgba(31,37,89,0.12)] bg-[rgba(34,181,115,0.12)] p-5 shadow-[0_34px_76px_rgba(34,46,121,0.10)] md:p-7">
            ...
            <div>
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                {simulations.map((simulation) => (
                  <div key={simulation.label} className="rounded-[16px] border border-[color:rgba(31,37,89,0.08)] bg-[rgba(34,181,115,0.10)] p-4">
    ...
    <div className="pb-12">
      <ShellContainer className="pt-8 md:pt-12">
        <motion.section
          ...
          className="relative overflow-hidden rounded-[36px] border border-[color:rgba(31,37,89,0.12)] bg-[var(--rb-surface)] px-5 py-10 shadow-[0_40px_90px_rgba(34,46,121,0.10)] md:px-8 md:py-12 lg:px-12 lg:py-14"
        >
          ...
          <div className="absolute inset-y-0 right-0 w-[28%] bg-[radial-gradient(circle_at_right,rgba(91,92,234,0.06),transparent_70%)]" aria-hidden="true" />
      ...
      <ShellContainer className="mt-20 space-y-24">
          ...
          <section data-home-section="problem" className="space-y-8">
            ...
            <div className="rounded-[30px] border border-[color:rgba(31,37,89,0.12)] bg-[var(--rb-surface)] p-5 md:p-7">
              <div className="grid gap-8 lg:grid-cols-[minmax(0,1.08fr)_minmax(280px,0.82fr)]">
                <div className="rounded-[24px] border border-[color:rgba(31,37,89,0.08)] bg-[rgba(31,37,89,0.02)] p-5">
                ...
                <div className="space-y-6">
                  {content.home.problem.items.map((item) => (
                    <div key={item.title} className="border-t border-[color:rgba(31,37,89,0.1)] pt-5">
        ...
        <Reveal>
          <section data-home-section="solution" className="space-y-8">
            ...
            />
            <div className="rounded-[30px] border border-[color:rgba(31,37,89,0.12)] bg-[var(--rb-surface)] p-5 md:p-7">
              <div className="flex flex-wrap items-center gap-3 border-b border-[color:rgba(31,37,89,0.08)] pb-6 text-sm text-[var(--rb-muted-strong)]">
              ...
              <div className="mt-7 grid gap-4 xl:grid-cols-4">
                {content.home.solution.strip.map((item) => (
                  <div key={item.title} className="rounded-[24px] border border-[color:rgba(31,37,89,0.08)] bg-[rgba(31,37,89,0.03)] p-5">
                    <div className="flex h-24 items-center justify-center rounded-[18px] border border-[color:rgba(31,37,89,0.08)] bg-[rgba(31,37,89,0.04)]">
              ...
              <div className="mt-7 flex flex-wrap gap-x-8 gap-y-3 border-t border-[color:rgba(31,37,89,0.08)] pt-6 text-sm text-[var(--rb-muted-strong)]">
        ...
        <Reveal>
          <section data-home-section="pricing" className="space-y-8">
            ...
            />
            <div className="overflow-hidden rounded-[30px] border border-[color:rgba(31,37,89,0.12)] bg-[var(--rb-surface)]">
              <div className="grid gap-0 lg:grid-cols-3">
                {pricing.plans.map((plan) => (
                  <div
                    key={plan.name}
                    className={`border-b border-[color:rgba(31,37,89,0.08)] px-5 py-6 last:border-b-0 lg:border-b-0 lg:border-r last:lg:border-r-0 md:px-7 ${
                  ...
                  >
                    ...
                    <div className="mt-6 space-y-3">
                      {plan.features.map((feature) => (
                        <div key={feature.label} className="flex items-center justify-between gap-4 border-t border-[color:rgba(31,37,89,0.08)] pt-3 text-sm">
        ...
        <Reveal>
          <section data-home-section="faq" className="space-y-8">
            ...
            <div className="border-t border-[color:rgba(31,37,89,0.08)]">
              {content.home.faq.items.map((item) => (
                <div key={item.question} className="grid gap-4 border-b border-[color:rgba(31,37,89,0.08)] py-6 md:grid-cols-[280px_minmax(0,1fr)]">
            ...
            <div className="grid gap-4 lg:grid-cols-3">
              {[
                ...
                <Link
                  key={card.href}
                  href={card.href}
                  className="rounded-[26px] border border-[color:rgba(31,37,89,0.12)] bg-[var(--rb-surface)] p-5 transition hover:border-[color:rgba(91,92,234,0.24)] hover:bg-[var(--rb-surface)] md:p-6"
                >
        ...
        <Reveal>
          <section data-home-section="cta">
            <div className="rounded-[30px] border border-[color:rgba(31,37,89,0.12)] bg-[linear-gradient(180deg,rgba(229,234,243,0.94),rgba(208,216,230,0.92))] px-5 py-7 text-[#111827] shadow-[0_30px_60px_rgba(34,46,121,0.08)] md:px-8 md:py-9">
