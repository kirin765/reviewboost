...
export default function TerminalProgress({
  ...
  return (
    <section
      className={cn(
        "rounded-2xl border border-[color:var(--rb-border-strong)] bg-[rgba(255,255,255,0.86)] p-5 shadow-[0_24px_50px_rgba(34,46,121,0.10)]",
        className
      )}
      role="status"
      aria-live="polite"
    >
      ...
      <div className="rounded-[14px] border border-[color:rgba(31,37,89,0.06)] bg-[rgba(31,37,89,0.02)] p-4 font-mono text-sm">
      ...
      <div className="mt-4">
        ...
        <div className="h-2 overflow-hidden rounded-full bg-[rgba(31,37,89,0.06)]">
          {reducedMotion ? (
