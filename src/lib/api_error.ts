export type ApiErrorCode =
  ...
  | "COUPANG_OPENAPI_NOT_CONFIGURED"
  | "COUPANG_OPENAPI_INVALID_REQUEST"
  | "COUPANG_OPENAPI_UNAUTHORIZED"
  | "COUPANG_OPENAPI_UPSTREAM_ERROR"
  | "COUPANG_OPENAPI_INVALID_RESPONSE";
...
export const apiErrorStatus: ApiErrorStatusMap = {
  ...
  COUPANG_OPENAPI_NOT_CONFIGURED: 503,
  COUPANG_OPENAPI_INVALID_REQUEST: 400,
  COUPANG_OPENAPI_UNAUTHORIZED: 401,
  COUPANG_OPENAPI_UPSTREAM_ERROR: 502,
  COUPANG_OPENAPI_INVALID_RESPONSE: 502
} as const;
